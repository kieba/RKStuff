...
public class AcceleratorConfig {
    ...
    public static int MAX_START_END_LENGTH = 22;
    public static int MAX_SIDE_LENGTH = 25;

    public static int COOLANT_PER_FLUID_IO = 1000;
    public static float MAX_ROUNDS_PER_TICK = 0.75f;
    ...
    public static float DECELERATION_PER_CENTIGRADE_IN_PERCENT = 0.015f;
    ...
    public static float HEAT_ENERGY_PER_SPEED = 100.0f;
