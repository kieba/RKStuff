...
public class Reference {
    ...
    public static final String MOD_NAME = "RKStuff";
    public static final String MOD_ID = "rkstuff";
    ...
    public static final String BLOCK_ACCELERATOR_CORE = "AcceleratorCore";
    public static final String BLOCK_ACCELERATOR_CASE = "AcceleratorCase";
    public static final String BLOCK_ACCELERATOR_CASE_BEVEL_LARGE = "AcceleratorCaseBevelLarge";
    public static final String BLOCK_ACCELERATOR_CASE_BEVEL_SMALL = "AcceleratorCaseBevelSmall";
    public static final String BLOCK_ACCELERATOR_CASE_BEVEL_SMALL_INVERTED = "AcceleratorCaseBevelSmallInverted";
    public static final String BLOCK_ACCELERATOR_CASE_FLUID_IO = "AcceleratorCaseFluidIO";
    public static final String BLOCK_ACCELERATOR_CONTROL_CASE = "AcceleratorControlCase";
    public static final String BLOCK_ACCELERATOR_CONTROL_CORE = "AcceleratorControlCore";
    public static final String BLOCK_ACCELERATOR_CONTROL_ENERGY_IO = "AcceleratorControlEnergyIO";
    public static final String BLOCK_ACCELERATOR_CONTROL_ITEM_IO = "AcceleratorControlItemIO";
    public static final String BLOCK_LHC_MASTER = "LHCMaster";
    public static final String BLOCK_FUSION_REACTOR_MASTER = "FusionReactorMaster";
    ...
    public static final String TILE_ACCELERATOR_CASE_FLUID_IO = "TileAcceleratorCaseFluidIO";
    public static final String TILE_ACCELERATOR_CONTROL_ENERGY_IO = "TileAcceleratorControlEnergyIO";
    public static final String TILE_ACCELERATOR_CONTROL_ITEM_IO = "TileAcceleratorControlItemIO";
    public static final String TILE_FUSION_REACTOR_MASTER = "TileFusionReactorMaster";
    public static final String TILE_LHC_MASTER = "TileLHCMaster";
