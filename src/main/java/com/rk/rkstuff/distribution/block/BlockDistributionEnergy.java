...
public class BlockDistributionEnergy extends BlockRK implements ITileEntityProvider, IPeripheralProvider {
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        return new TileDistributionEnergy();
    }
    ...
    protected IIcon loadIconById(String suffix, IIconRegister iconRegister) {
        return iconRegister.registerIcon(Reference.MOD_ID + ":distribution/" + Reference.BLOCK_DISTRIBUTION_ENERGY + suffix);
    }
